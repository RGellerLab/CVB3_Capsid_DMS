This folder contains the data required to perform the linear model and random forest model of MFE using R. 

1. data_predictions.csv: data used for prediction
